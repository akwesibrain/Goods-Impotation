...
-- ============================================================
-- AI assistant — configurable knowledge + staff-only chat log
-- The OpenAI key lives in Edge Function secrets, never here.
-- Guests may read ai_settings. Only the service role writes
-- ai_messages (from supabase/functions/ai-chat).
-- ============================================================

...
from (values
  ('Plug-in mosquito liquid diffuser', 'Kitchen & Home', '/assets/products/mosquito-diffuser.jpg', 'Plug-in liquid mosquito killer for Ghana rooms and shops. Refills are easy to restock. Accra quotes landed GH₵ — type the price in admin.'),
  ...
  ('Home treadmills (folding, walking pad, compact)', 'Electronics', '/assets/products/home-treadmills.jpg', 'Folding walking-pad treadmills for Accra homes and small gyms. Confirm 220V / Ghana plug. Staff add the GH₵ price in admin.'),
  ...
  ('Professional hair dryer styling kit', 'Beauty & Cosmetics', '/assets/products/hair-dryer-kit.jpg', 'Salon hair-dryer kit for Ghana 220V sockets. Share the model you want. Accra types the landed GH₵ price in admin.'),
  ('Portable charcoal cookstove', 'Kitchen & Home', '/assets/products/charcoal-cookstove.jpg', 'Portable charcoal stove for outdoor cooking and small chop businesses. Ask Accra for a landed GH₵ quote, then save it in admin.'),
  ...
  ('Ceramic serving pot set', 'Kitchen & Home', '/assets/products/ceramic-serving-pots.jpg', 'Ceramic serving pots for home and chop-bar presentation. Ask Accra for a landed GH₵ quote and type it in admin.')
...
from (values
  ('Plug-in mosquito liquid diffuser', 'Plug-in liquid mosquito killer for Ghana rooms and shops. Refills are easy to restock. Accra quotes landed GH₵ — type the price in admin.'),
  ...
  ('Home treadmills (folding, walking pad, compact)', 'Folding walking-pad treadmills for Accra homes and small gyms. Confirm 220V / Ghana plug. Staff add the GH₵ price in admin.'),
  ...
  ('Professional hair dryer styling kit', 'Salon hair-dryer kit for Ghana 220V sockets. Share the model you want. Accra types the landed GH₵ price in admin.'),
  ('Portable charcoal cookstove', 'Portable charcoal stove for outdoor cooking and small chop businesses. Ask Accra for a landed GH₵ quote, then save it in admin.'),
  ...
  ('Ceramic serving pot set', 'Ceramic serving pots for home and chop-bar presentation. Ask Accra for a landed GH₵ quote and type it in admin.')
